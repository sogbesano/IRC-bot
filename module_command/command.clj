...
(defn get-loaded-modules-keys
  ...
  (let 
    [
      all-modules (vec (map (fn [module] (keys module)) loaded-modules))
    ]
...
(defn get-module-cmd
  ...
  (first 
    (for 
      [module (get-all-module-cmds loaded-modules)] 
...
(defn invoke-module-cmd
  ...
  (let 
    [module-cmd ((keyword module-cmd-name) (get-module-cmd module-cmd-name loaded-modules))]
